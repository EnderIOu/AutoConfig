...
public class SlaveFactory implements IValueFactory {
    ...
    @Override
    public @Nonnull IValue<List<String>> make(@Nonnull String keyname, @Nonnull List<String> defaultValue,
                                              @Nonnull String text) {
        return new StringListValue(this, section, keyname, defaultValue, text).preload();
    }

    @Override
    public @Nonnull IValue<String> make(@Nonnull String keyname, @Nonnull String defaultValue, @Nonnull String[] limit,
                                        @Nonnull String text) {
    ...
    @Override
    public @Nonnull <E extends Enum<E>> IValue<E> make(@Nonnull String keyname, @Nonnull E defaultValue,
                                                       @Nonnull String text) {
     ...
     */
    @Override
    public @Nonnull IValue<Fluid> makeFluid(@Nonnull String keyname, @Nonnull String defaultValue,
                                            @Nonnull String text) {
