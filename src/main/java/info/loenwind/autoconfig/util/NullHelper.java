...
public final class NullHelper {
    ...
    /**
     * Returns the first non-<code>null</code> parameter or thrown a {@link NullPointerException} if there is none.
     */
    @SafeVarargs
    public static <P> @NotNull P first(@Nullable P... o) {
        for (P on : notnull(o, "... param is null")) {
            if (on != null) {
                return on;
            }
        }
